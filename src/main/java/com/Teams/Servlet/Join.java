...
public class Join extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if(itr1.hasNext())
		{
			out.print("<html><body><body style =\"background-color:AliceBlue;\"/><center><br><br><br><br><h1>Adding Failed</h1><h2>You are Alredy In that Team<h2><h3>Or There Is A "+subject+" Teacher<h3></center></body></html>");
